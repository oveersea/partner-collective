...
import { ArrowLeft, Save, Calendar, Users, Star, MapPin, Award, X, Plus } from "lucide-react";
      ...
      <header className="sticky top-0 z-40 bg-card border-b border-border">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-sm font-semibold text-foreground truncate max-w-[300px]">{data.title}</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card>
              ...
              <CardContent>
                <Textarea rows={3} value={data.admin_notes || ""} onChange={(e) => update("admin_notes", e.target.value)} placeholder="Catatan internal..." />
              </CardContent>
            </Card>
          </div>
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <Input value={data.organizer_type || ""} onChange={(e) => update("organizer_type", e.target.value)} />
                </div>
                <div>
                  <Label>Badge</Label>
            ...
            {/* Stats */}
            <Card>
              <CardHeader><CardTitle className="text-base">Statistik</CardTitle></CardHeader>
              <CardContent className="space-y-4">
                <div>
            ...
            {/* Location */}
            <Card>
              <CardHeader><CardTitle className="text-base flex items-center gap-2"><MapPin className="w-4 h-4" /> Lokasi</CardTitle></CardHeader>
              <CardContent className="space-y-4">
                <div>
                  <Label>Lokasi</Label>
