        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="bg-card rounded-2xl border border-border p-8 shadow-card space-y-6">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => set("project_duration", e.target.value)}
            >
