      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-display text-lg font-bold" style={{ color: "hsl(0 0% 93%)" }}>PartnerHub</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["Hiring Request", "Project Request", "Cari Partner", "Cari Tim"].map((item) => (
                <li key={item}><a href="#" className="text-sm hover:text-emerald transition-colors" style={{ color: "hsl(220 20% 55%)" }}>{item}</a></li>
              ))}
            </ul>
          </div>
        ...
        <div className="border-t border-border/20 pt-8 text-center">
          <p className="text-sm" style={{ color: "hsl(220 20% 45%)" }}>
            © 2026 PartnerHub. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
