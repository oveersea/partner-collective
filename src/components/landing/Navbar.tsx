...
const megaMenus: MegaMenuData[] = [
  {
    label: "Services",
    tagline: "On-demand services for all your business needs",
    ...
    masters: [
      {
        ...
        icon: Briefcase,
        subItems: [
          { icon: Briefcase, title: "Cleaning", description: "Professional cleaning staff for homes & offices", href: "/services" },
          { icon: Shield, title: "Security Guard", description: "Trained security officers & guards", href: "/services" },
          { icon: Building2, title: "Civil (Construction)", description: "Renovation, repair, & construction", href: "/services" },
          { icon: Users, title: "Sales (Temp & Perm)", description: "B2B & B2C sales professionals", href: "/services" },
        ],
      },
      {
        label: "Digital Services",
        description: "Creative & digital professionals",
        icon: Monitor,
        subItems: [
          { icon: Monitor, title: "Content Creator", description: "Photo, video, & social media content", href: "/services" },
          { icon: Target, title: "Digital Marketer", description: "SEO, SEM, ads, & growth hacking", href: "/services" },
          { icon: FileText, title: "Secretary", description: "Professional assistants & administration", href: "/services" },
        ],
      },
      {
        label: "Professional Services",
        description: "Verified consultants & experts",
        icon: Award,
        subItems: [
          { icon: Shield, title: "Legal & Lawyer", description: "Legal consultants & attorneys", href: "/services" },
          { icon: BarChart3, title: "Finance & Tax", description: "Accountants & tax consultants", href: "/services" },
          { icon: Briefcase, title: "Business Consulting", description: "Business & strategy consultants", href: "/services" },
        ],
      },
      {
        label: "Enterprise",
        ...
        subItems: [
          ...
          { icon: FolderOpen, title: "Project Request", description: "Post your project requirements", href: "/project-request" },
          { icon: Handshake, title: "Hiring Request", description: "Submit a recruitment request", href: "/hiring-request" },
          { icon: PackageCheck, title: "Bulk Order", description: "Large-scale workforce ordering", href: "/order" },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    masters: [
      ...
      },
      {
        ...
        icon: Target,
        subItems: [
          { icon: Target, title: "Choose Career Path", description: "Explore available career paths", href: "/career-path" },
          { icon: Compass, title: "Career Recommendations", description: "Career suggestions based on skills & interests", href: "/career-path?tab=recommendations" },
          { icon: TrendingUp, title: "Skill Gap Analysis", description: "Identify skills that need improvement", href: "/career-path?tab=gap-analysis" },
          { icon: Star, title: "Career Roadmap", description: "Your roadmap to your dream career", href: "/career-path?tab=roadmap" },
        ],
      },
    ],
  },
