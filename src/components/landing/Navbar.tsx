...
const megaMenus: MegaMenuData[] = [
  {
    label: "Layanan",
    tagline: "On-demand services untuk semua kebutuhan bisnis Anda",
    cta: { label: "Lihat semua layanan", href: "/services" },
    masters: [
      {
        label: "Layanan Fisik",
        description: "Tenaga kerja operasional",
        icon: Briefcase,
        subItems: [
          { icon: Briefcase, title: "Cleaning", description: "Tenaga kebersihan profesional untuk rumah & kantor", href: "/services" },
          { icon: Shield, title: "Pengamanan (Guard)", description: "Satpam & petugas keamanan terlatih", href: "/services" },
          { icon: Building2, title: "Civil (Tukang Bangunan)", description: "Renovasi, perbaikan, & konstruksi", href: "/services" },
          { icon: Users, title: "Sales (Temp & Perm)", description: "Tenaga penjualan B2B & B2C", href: "/services" },
        ],
      },
      {
        label: "Layanan Digital",
        description: "Profesional kreatif & digital",
        icon: Monitor,
        subItems: [
          { icon: Monitor, title: "Content Creator", description: "Foto, video, & konten sosial media", href: "/services" },
          { icon: Target, title: "Digital Marketer", description: "SEO, SEM, ads, & growth hacking", href: "/services" },
          { icon: FileText, title: "Secretary", description: "Asisten & administrasi profesional", href: "/services" },
        ],
      },
      {
        label: "Layanan Profesional",
        description: "Konsultan & ahli terverifikasi",
        icon: Award,
        subItems: [
          { icon: Shield, title: "Legal & Lawyer", description: "Konsultan hukum & pengacara", href: "/services" },
          { icon: BarChart3, title: "Finance & Tax", description: "Akuntan & konsultan pajak", href: "/services" },
          { icon: Briefcase, title: "Business Consulting", description: "Konsultan bisnis & strategi", href: "/services" },
        ],
      },
      {
        label: "Enterprise",
