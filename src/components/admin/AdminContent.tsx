  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-xl font-semibold text-foreground">Opportunities & Jobs</h2>
                ...
                {filteredProgs.length === 0 ? (
                  ...
                  pagedProgs.map((p) => (
                    <tr key={p.id} className="border-b border-border hover:bg-muted/30 transition-colors">
                      ...
                      <td className="px-4 py-3 text-muted-foreground text-xs">{new Date(p.created_at).toLocaleDateString("en-US")}</td>
                      <td className="px-4 py-3 text-right">
